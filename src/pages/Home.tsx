    ...
    <section className="flex flex-col lg:flex-row h-full p-6 items-center min-h-[70vh]">
      ...
      >
        ...
        <h1 className="text-white font-extrabold text-4xl md:text-6xl">
          I'am Muhammad Yusron
        </h1>
        <h2 className="text-teal-500 font-bold text-xl md:text-3xl">
          Programmer
        </h2>
        <p className="text-center md:text-start text-xs md:text-base">
          Hello World! I am a passionate programmer who is always ready to explore the boundaries of technology. With a pile of code in hand, I strive to create innovative solutions that change the world.
          With every line of code I write, I bring my vision to create great experiences for users and deliver efficient solutions to complex technical problems.
          Let's explore together how code can change the world. I'm ready to create a better future, one line of code at a time!
          #ProgrammerLife #CodeCreator #InnovationJourney
        </p>
        <Link to="./CV-Muhammad-Yusron.pdf" target="_blank">
          <motion.div
